...
import com.example.belajarfirebase2.AuthActivity
import com.google.firebase.auth.EmailAuthProvider
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.auth.FirebaseAuthInvalidCredentialsException
import com.google.firebase.storage.FirebaseStorage
import com.example.belajarfirebase2.ChangeEmailActivity
import com.example.belajarfirebase2.CodeScannerActivity
import com.example.belajarfirebase2.databinding.FragmentUserBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (user != null){
            ...
            imageRef.downloadUrl.addOnSuccessListener {
                ...
                Picasso.get().load(it).into(cvi_user);
            }
    ...
    private fun makeReq() {
        activity?.let {
            ActivityCompat.requestPermissions(
                it, arrayOf(android.Manifest.permission.CAMERA), 101
            )
        }
    }
